...
{ 
  ...
  $sql="INSERT INTO  user(user_name,password,contact,gender,age,dob) VALUES(:username,:password,:email,:gender,:age,:dob)";
...
<form class="modal-content animate"  method="post">
  ...
  <label for="gender"><b>Gender</b></label>
    <select name="gender" id="gender" class="form-control">Select Gender
       <option selected="Select your Gender">Select your Gender</option>
      <option>Male</option>
      <option>Female</option>
    </select>
 <label for="uname"><b>Age</b></label>
    <input type="text" name="age" class="form-control" id="inputEmail3" placeholder="Age" required>
    <label>


      <label for="uname"><b>DOB</b></label>
    <input type="date" name="dob" class="form-control" id="inputEmail3" placeholder="DOB" required>
    <label>
