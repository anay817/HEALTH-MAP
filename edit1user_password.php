...
{ 
     ?>
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                    <input type="text" name="password" class="form-control" required="required" id="success"placeholder="Enter Current Password"  value="<?php echo ($result1->Username)?>">
                                                       ...
                                                       <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="text" name="newpassword" required="required" class="form-control" id="success"placeholder="Enter New Password" >
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
