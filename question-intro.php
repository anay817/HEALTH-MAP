...
<td class="result-red">I am Overweight and Obese   &nbsp</td>
        <td class="result-red"><input type="radio" name="overweight" value="Yes" required>Yes  &nbsp &nbsp <input type="radio" name="overweight" value="No" required>No </td>

</tr>

<tr>

<td class="result-red">I Smoke Cigaretts   &nbsp</td>
        <td class="result-red"><input type="radio" name="overweight1" value="Yes" required>Yes  &nbsp &nbsp <input type="radio" name="overweight1" value="No" required>No </td>
                                                                           
</tr>
<tr>

<td class="result-red" >I have high Cholesterol &nbsp</td>
        <td class="result-red"><input type="radio" name="overweight2" value="Yes" required>Yes  &nbsp &nbsp <input type="radio" name="overweight2" value="No" required>No </td>
                                                                           
</tr>
<tr>

<td class="result-red">I have hypertention   &nbsp</td>
        <td class="result-red"><input type="radio" name="overweight3" value="Yes" required>Yes  &nbsp &nbsp <input type="radio" name="overweight3" value="No" required>No </td>
                                                                           
</tr>
<tr>

<td class="result-red">I have diabates   &nbsp</td>
        <td class="result-red"><input type="radio" name="overweight4" value="Yes" required>Yes  &nbsp &nbsp <input type="radio" name="overweight4" value="No" required>No </td>
