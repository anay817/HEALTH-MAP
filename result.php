...
<html lang="en">
                ...
                <form class="form-horizontal" method="post">
                    ...
                    <table id="example"  >  -->
                        ...
                        <tbody>
                            ...
                            if($query->rowCount() > 0)
                            {
                            echo $results->disease_name;
                            foreach($results as $result)
                            {   ?>
                            <tr>
                                <!-- <?php echo htmlentities($cnt);?> -->
                                <h2>SUGGESTED DISEASE </h2>
                                <h3 class="result-color">&nbsp &nbsp<?php echo htmlentities($resultdisease_name);?>
                                <h3 class="result-color">&nbsp &nbsp<?php echo $mainresult;?>
                                
                                </h3><br>
                                <h2>CAUSE</h2>
                                <h2 > <td class="result-color1"><?php echo htmlentities($resultcause);?></td><h2>
    ...
    echo "<script>alert('PLz register first and log in to save your result');</script>";
            ...
            <div class="flex-p">
                <div class="content-p">
                    ...
                    <div class="flex-p-inside">
                     ...
                     <div class="flex-p-inside">
                        <div>
                         <button> <a href="user_interface.php" style="text-align:center;"><b style="color:white">Back</b></a></button>
                        </div>
                    </div>
                </div>
                <!-- /.main-wrapper -->
