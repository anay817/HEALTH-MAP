...
<tr>
 <!-- <?php echo htmlentities($cnt);?> -->
             ...
             <!--  <td class="result-color1"><input type="radio" name="<?php echo htmlentities($cnt);?>" value="Yes" required>Yes  &nbsp &nbsp <input type="radio" name="<?php echo htmlentities($cnt);?>" value="No" required>No </td> -->
              ...
              <td>
                  <label class="radio-pill" style="color:#fff;">
                  <input type="radio" name="<?php echo htmlentities($cnt);?>" value="Yes" required>Yes  </label>&nbsp &nbsp
                <label class="radio-pill" style="color:#fff;"><input type="radio" name="<?php echo htmlentities($cnt);?>" value="No" required>No 
              </label>
              </td>
...
<li><button type="submit" name="submit" >SUBMIT</button></li> 
     ...
     <div class="flex-p-inside">
     <div class="flex-p-1">
     <li><a href="user_interface.php" ><button><<</button></li>
</div>
</div>
